...
export async function POST(req: Request) {
    try {
        ...
        const prompt = `
당신은 수능 수학을 다 까먹은 30~50대 성인들에게 수학 문제를 다시 가르쳐주는 친절한 AI 선생님입니다.
...
1. 친근하고 다정한 말투를 사용하되, 너무 유치하거나 부담스러운 호칭(예: 삼촌, 이모 등)은 사용하지 마세요.
2. 문제의 핵심 개념을 중학교/고등학교 1학년 수준의 쉬운 용어로 먼저 짚어주세요.
